...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language Gesture To Text and Speech Conversion")
        ...
        self.T.config(text="Sign Language Gesture To Text and Speech Conversion", font=("Courier", 30, "bold"))
        ...
        self.T3.config(text="Sentence :", fg="blue" , font=("Courier", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=700)
        self.T4.config(text="Suggestions :", fg="green", font=("Courier", 30, "bold"))
